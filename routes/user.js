...
router.get('/pengguna', function(req, res, next) {
  ...
  if(query_url.cari == undefined){
    ...
    sql='select distinct * from tbpengguna,tbjenis_pengguna where tbpengguna.id_jenis=tbjenis_pengguna.id_jenis or tbpengguna.username like "%'+query_url.cari+'%" or tbpengguna.nm_pengguna like "%'+query_url.cari+'%" or tbpengguna.email like "%'+query_url.cari+'%" or tbpengguna.nohp like "%'+query_url.cari+'%";';
  }
